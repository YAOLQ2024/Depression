...
def ocr_pdf_folder(folder_path):
    ...
    #在 3.3.1 这个版本里，PaddleOCR.__init__ 根本就没有 page_num 这个参数，用新版推荐参数名
    ...
    for pdf_path in pdf_paths:  
        ...
        #ocr() 已经是个 过时的包装函数，内部直接调 predict(img, **kwargs)；但新的 predict() 不再接受 cls 这个参数；
        # predict 方法在 3.3.1 版本里是新增的，用于预测PDF文件中的文本
